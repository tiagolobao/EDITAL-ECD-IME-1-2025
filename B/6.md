...
- Boxplots são diagramas que dão informações gráficas de várias medidas ao mesmo tempo: mediana, quartil, amplitude e outliers.
...
# Para dados agrupados, não se usa n+1, mesmo o número de amostras sendo par!!!
...
# 10 + 12 + 8 = 30, então o terceiro quartil está no 12 - 16
# ((16 - 12) / 8) = ((quartil_3 - 12) / 5)
quartil_3 <- (((16 - 12) / 8) * 5) + 12
quartil_3
# [1] 14.5

# O valor real vai ser diferente, mas o R não dá a opção de plotar apenas com o valor dos quartis.
# Então esse plot vai apenas como referência
...
<img alt="Esboço box plot" src="../assets/figura_8.png" width="350">
